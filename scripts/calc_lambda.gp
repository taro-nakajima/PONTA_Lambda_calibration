...
#fit TTH_cal(x) "fit_results.txt" u 4:9:10 yerror via Lambda
...
set xlabel 'd (A)' font "Arial,22"
set ylabel '2th_{obs} - 2th_{cal} (deg)' font "Arial,22"
